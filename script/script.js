...
/* --------- */
let menuItems,
    rowItalia = document.querySelector("#row-italia"),
    rowAustria = document.querySelector("#row-austria"),
    rowAlemania = document.querySelector("#row-alemania"),
    rowCzech = document.querySelector("#row-czech"),
...
function updateOrder(clean) {
    ...
    order = [];
    form.innerHTML = '<input type="hidden" name="_next" value="https://fedenh3.github.io/Hurtado-Final-JavaScript/?#headingOne"><input type="hidden" name="_captcha" value="false">'; 
...
function createMenuCard(type, description, price, available, source) {
    ...
    switch (type) {
        case "Italia":
            rowItalia.appendChild(divCol);
            break;
        case "Austria":
            rowAustria.appendChild(divCol);
            break;
        case "Alemania":
            rowAlemania.appendChild(divCol);
            break;
        case "Czech":
            rowCzech.appendChild(divCol);
            break;
    }
...
function createSettingsRow(type, description, price, available, source) {
    ...
    option1.value = "Italia";
    option1.textContent = "Italia";
    inputType.appendChild(option1);
    let option2 = document.createElement("option");
    option2.value = "Austria";
    option2.textContent = "Austria";
    inputType.appendChild(option2);
    let option3 = document.createElement("option");
    option3.value = "Alemania";
    option3.textContent = "Alemania";
    inputType.appendChild(option3);
    let option4 = document.createElement("option");
    option4.value = "Czech";
    option4.textContent = "Czech";
...
function createMenuAndSettings(products) {
    ...
    rowItalia.innerHTML = "";
    rowAustria.innerHTML = "";
    rowAlemania.innerHTML = "";
    rowCzech.innerHTML = "";
